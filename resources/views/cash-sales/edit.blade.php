...
@section('content')
    ...
    <!-- Edit Form Section -->
    <section class="edit-sale-section py-5">
        <div class="container">
                    ...
                    <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
                        <div class="card-header bg-gradient-warning text-white py-4">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    <h4 class="mb-0">تعديل عملية البيع رقم: {{ $cashSale->id }}</h4>
                                    <p class="mb-0 opacity-75">قم بتعديل المعلومات المطلوبة</p>
                                </div>
                            </div>
                        </div>

                        <div class="card-body p-4">
                            <form method="POST" action="{{ route('cash-sales.update', $cashSale->id) }}" id="editSaleForm">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-12">
                                        <div class="section-header mb-3">
                                            ...
                                            <div class="border-bottom border-primary border-2 mt-2" style="width: 60px;">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="car_brand_id" id="car_brand_id"
                                                class="form-select form-select-lg @error('car_brand_id') is-invalid @enderror"
                                                required>
                                                <option value="">اختر ماركة السيارة</option>
                                                @foreach ($carBrands as $brand)
                                                    <option value="{{ $brand->id }}"
                                                        {{ old('car_brand_id', $cashSale->car_brand_id) == $brand->id ? 'selected' : '' }}>
                                                        {{ $brand->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="car_model_id" id="car_model_id"
                                                class="form-select form-select-lg @error('car_model_id') is-invalid @enderror"
                                                required>
                                                <option value="">اختر ماركة أولاً</option>
                                                @foreach ($models as $model)
                                                    <option value="{{ $model->id }}"
                                                        {{ old('car_model_id', $cashSale->car_model_id) == $model->id ? 'selected' : '' }}>
                                                        {{ $model->name }} ({{ $model->model_year }})
                                                    </option>
                                                @endforeach
                                            </select>
                                            @error('car_model_id')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-lg">
                                                <input type="text" name="car_color"
                                                    ...
                                                    value="{{ old('car_color', $cashSale->car_color) }}"
                                                    placeholder="أدخل لون السيارة" required>
                                                <button type="button" class="btn btn-outline-secondary"
                                                    data-bs-toggle="modal" data-bs-target="#colorPickerModal">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="car_category"
                                                class="form-control form-control-lg @error('car_category') is-invalid @enderror"
                                                value="{{ old('car_category', $cashSale->car_category) }}"
                                                placeholder="مثال: سيدان فاخرة" required>
                                            @error('car_category')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                            ...
                                            <div class="d-flex gap-3">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="source"
                                                        id="in_stock" value="in_stock"
                                                        {{ old('source', $cashSale->source) == 'in_stock' ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="source"
                                                        id="external_purchase" value="external_purchase"
                                                        {{ old('source', $cashSale->source) == 'external_purchase' ? 'checked' : '' }}>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-lg">
                                                <input type="number" name="car_price"
                                                    class="form-control @error('car_price') is-invalid @enderror"
                                                    value="{{ old('car_price', $cashSale->car_price) }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label fw-bold">
                                                <i class="fas fa-money-check-alt me-2 text-primary"></i>المبلغ المدفوع
                                                (ريال)
                                                <span class="text-danger">*</span>
                                            </label>
                                            <div class="input-group input-group-lg">
                                                <input type="number" name="paid_amount"
                                                    ...
                                                    value="{{ old('paid_amount', $cashSale->paid_amount) }}"
                                                    placeholder="0.00" step="0.01" min="0" required
                                                    oninput="calculateRemaining()">
                                                <span class="input-group-text bg-primary text-white">ر.س</span>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-lg">
                                                <input type="number" id="remaining_amount" class="form-control bg-light"
                                                    value="{{ old('remaining_amount', $cashSale->remaining_amount) }}"
                                                    readonly>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="bank_id"
                                                class="form-select form-select-lg @error('bank_id') is-invalid @enderror">
                                                <option value="">اختر البنك</option>
                                                @foreach ($banks as $bank)
                                                    <option value="{{ $bank->id }}"
                                                        {{ old('bank_id', $cashSale->bank_id) == $bank->id ? 'selected' : '' }}>
                                                        {{ $bank->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label fw-bold">
                                                <i class="fas fa-info-circle me-2 text-primary"></i>حالة الدفع
                                                <span class="text-danger">*</span>
                                            </label>
                                            <select name="payment_status"
                                                class="form-select form-select-lg @error('payment_status') is-invalid @enderror"
                                                required>
                                                @foreach ($statuses as $key => $status)
                                                    <option value="{{ $key }}"
                                                        {{ old('payment_status', $cashSale->payment_status) == $key ? 'selected' : '' }}>
                                                        {{ $status }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="notes" class="form-control @error('notes') is-invalid @enderror" rows="3"
                                                placeholder="أدخل أي ملاحظات إضافية...">{{ old('notes', $cashSale->notes) }}</textarea>
                                            @error('notes')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-12 mt-4">
                                        <div class="d-flex justify-content-between">
                                            <a href="{{ route('cash-sales.show', $cashSale->id) }}"
                ...
                <div class="modal-body">
                    ...
                    <div class="mt-3">
                        ...
                        <div class="input-group">
                            <input type="text" id="customColor" class="form-control"
                                placeholder="#000000 أو اسم اللون">
                            <button type="button" class="btn btn-outline-primary"
                                onclick="selectCustomColor()">تطبيق</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="floating-buttons">
        <a href="{{ route('cash-sales.show', $cashSale->id) }}" class="floating-btn back-btn">
            <i class="fas fa-eye"></i>
            <span class="tooltip">عرض التفاصيل</span>
        </a>

        <a href="{{ route('cash-sales.index') }}" class="floating-btn list-btn">
            <i class="fas fa-list"></i>
            <span class="tooltip">قائمة المبيعات</span>
        </a>
    </div>
@endsection
...
@push('scripts')
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // عند تغيير الماركة، تحديث الموديلات
            ...
            //                 // تحديد الموديل الحالي إذا كان ينتمي للماركة المختارة
            //                 const currentModelId = @json($cashSale->car_model_id);
            //                 if (filteredModels.some(m => m.id == currentModelId)) {
            ...
            //     // تشغيل الحدث عند التحميل لتحميل الموديلات المناسبة
