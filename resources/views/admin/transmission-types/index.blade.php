...
@section('title', 'إدارة أنواع الجير')

@section('page-title', 'إدارة أنواع الجير')

@section('breadcrumb')
<li class="breadcrumb-item active">أنواع الجير</li>
@endsection
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header bg-primary text-white">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0 text-white">
                        <i class="fas fa-cog me-2"></i>قائمة أنواع الجير
                    </h5>
                    <a href="{{ route('admin.transmission-types.create') }}" class="btn btn-light">
            ...
            <div class="card-body">
                ...
                <div class="row mb-4">
                    <div class="col-md-8">
                        <form method="GET" action="{{ route('admin.transmission-types.index') }}" class="row g-3">
                            <div class="col-md-8">
                                <input type="text" 
                                       name="search" 
                                       class="form-control" 
                                       placeholder="ابحث باسم نوع الجير..."
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="transmission-icon me-2">
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <a href="{{ route('admin.transmission-types.show', $type->id) }}" 
                            ...
                            <tr>
                                <td colspan="5" class="text-center py-4">
                                    <div class="empty-state">
                                        ...
                                        <h5>لا يوجد أنواع جير</h5>
                                        <p class="text-muted">لم يتم إضافة أي أنواع جير بعد.</p>
