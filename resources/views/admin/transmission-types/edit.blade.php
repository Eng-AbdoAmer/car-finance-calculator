...
@section('title', 'تعديل نوع الجير')

@section('page-title', 'تعديل نوع الجير')
        ...
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h5 class="card-title mb-0 text-white">
                    <i class="fas fa-edit me-2"></i>تعديل نوع الجير: {{ $type->name }}
                </h5>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.transmission-types.update', $type->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" 
                               ...
                               placeholder="أدخل اسم نوع الجير الجديد"
                               required
                               autofocus>
                        @error('name')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <small class="text-muted">يمكنك تعديل اسم نوع الجير، ولكن تأكد من أن الاسم الجديد فريد وغير مكرر.</small>
                    </div>

                    <!-- معلومات النوع الحالية -->
                    <div class="info-section bg-light p-3 rounded mb-4">
                        <h6 class="mb-3"><i class="fas fa-history me-2"></i>معلومات النوع الحالية</h6>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-2">
                    ...
                    <div class="alert alert-warning">
                        ...
                        عند تعديل الاسم، سيتم تحديث جميع السيارات المرتبطة بهذا النوع تلقائياً.
                    </div>
                    @endif

                    <div class="d-flex justify-content-between mt-4">
                        <div>
                            <a href="{{ route('admin.transmission-types.show', $type->id) }}" class="btn btn-secondary me-2">
                                <i class="fas fa-eye me-1"></i> عرض
                            </a>
                            <a href="{{ route('admin.transmission-types.index') }}" class="btn btn-outline-secondary">
