...
@section('title', 'تفاصيل نوع الجير')

@section('page-title', 'تفاصيل نوع الجير')
            ...
            <div class="card-header bg-primary text-white">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0 text-white">
                        <i class="fas fa-eye me-2"></i>تفاصيل نوع الجير
                    </h5>
                    <div>
                        <a href="{{ route('admin.transmission-types.edit', $type->id) }}" class="btn btn-light btn-sm">
            ...
            <div class="card-body">
                ...
                <div class="info-section mb-4">
                    <div class="info-header bg-light p-3 rounded mb-3 d-flex align-items-center">
                        <div class="transmission-icon me-3">
                            <i class="fas fa-cogs fa-2x"></i>
                        </div>
                        <div>
                            <h6 class="mb-0"><i class="fas fa-info-circle me-2"></i>معلومات نوع الجير</h6>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                ...
                <div class="cars-section mb-4">
                    <div class="cars-header bg-light p-3 rounded mb-3 d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.cars.index', ['transmission_type_id' => $type->id]) }}" class="btn btn-sm btn-outline-primary">
