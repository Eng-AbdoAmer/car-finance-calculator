...
@section('title', 'تفاصيل نوع الدفع')

@section('page-title', 'تفاصيل نوع الدفع')
            ...
            <div class="card-header bg-primary text-white">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0 text-white">
                        <i class="fas fa-eye me-2"></i>تفاصيل نوع الدفع
                    </h5>
                    <div>
                        <a href="{{ route('admin.drive-types.edit', $type->id) }}" class="btn btn-light btn-sm">
            ...
            <div class="card-body">
                ...
                <div class="info-section mb-4">
                    <div class="info-header bg-light p-3 rounded mb-3 d-flex align-items-center">
                        ...
                        <div>
                            <h6 class="mb-0"><i class="fas fa-info-circle me-2"></i>معلومات نوع الدفع</h6>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="info-item mb-3">
                                ...
                                <div class="fw-bold">
                                    <code class="fs-5">{{ $type->code }}</code>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="cars-section mb-4">
                    <div class="cars-header bg-light p-3 rounded mb-3 d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.cars.index', ['drive_type_id' => $type->id]) }}" class="btn btn-sm btn-outline-primary">
