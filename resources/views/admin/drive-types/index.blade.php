...
@section('title', 'إدارة أنواع الدفع')

@section('page-title', 'إدارة أنواع الدفع')

@section('breadcrumb')
<li class="breadcrumb-item active">أنواع الدفع</li>
@endsection
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header bg-primary text-white">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0 text-white">
                        <i class="fas fa-cogs me-2"></i>قائمة أنواع الدفع
                    </h5>
                    <a href="{{ route('admin.drive-types.create') }}" class="btn btn-light">
            ...
            <div class="card-body">
                ...
                <div class="row mb-4">
                    <div class="col-md-8">
                        <form method="GET" action="{{ route('admin.drive-types.index') }}" class="row g-3">
                            <div class="col-md-8">
                                <input type="text" 
                                       name="search" 
                                       class="form-control" 
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <a href="{{ route('admin.drive-types.show', $type->id) }}" 
                            ...
                            <tr>
                                <td colspan="6" class="text-center py-4">
                                    <div class="empty-state">
                                        ...
                                        <h5>لا يوجد أنواع دفع</h5>
                                        <p class="text-muted">لم يتم إضافة أي أنواع دفع بعد.</p>
                                        <a href="{{ route('admin.drive-types.create') }}" class="btn btn-primary">
                                            <i class="fas fa-plus me-1"></i>إضافة نوع جديد
                                        </a>
                                    </div>
                                </td>
